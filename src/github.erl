...
start() ->
    ...
    application:ensure_started(webmachine),
    %ok = application:ensure_started(riak_sysmon),
    application:ensure_started(riak_core),
    application:ensure_started(riak_pipe),
    application:ensure_started(github),
